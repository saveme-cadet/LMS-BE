...
public class VacationController {
    ...
    public APIDataResponse<ResponseEntity<VacationResponse>> addVacation(@RequestBody @Valid AddVacationRequest vacationRequest,
                                                                        @PathVariable("userId") String userId) {
        VacationResponse vacationResponse = vacationService.addVacation(vacationRequest, userId);

        return APIDataResponse.of(ResponseEntity.ok().body(vacationResponse));
    }
    ...
    public APIDataResponse<ResponseEntity<VacationResponse>> useVacation(@RequestBody @Valid UseVacationRequest vacationRequest,
                                                        @PathVariable("userId") String userId) {
    ...
    public APIDataResponse<ResponseEntity<VacationResponse>> getRemainingVacation(@PathVariable("userId") String userId) {
    ...
    public APIDataResponse<ResponseEntity<List<VacationReasonResponse>>> getUsedVacation(@PathVariable("userId") String userId) {
        List<VacationReasonResponse> vacationResponses = vacationService.getUsedVacation(userId);

        return APIDataResponse.of(ResponseEntity.ok().body(vacationResponses));
    }
}